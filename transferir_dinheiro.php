...
<div id='conteudo'>
    ...
    <form action="transferir.php" method="post" enctype="multipart/form-data">

    <p> Escolha o destinatário da transferência bancária</p>
    ...
    <input type="number" min="1" step="any" id="valor" name="valor"> €
    
    <p> Descrição do movimento </p>
        <textarea name='descricao' id='descricao' > </textarea>
        
        <p><div class='center_content'><input id="submit_button" type="submit" value="Validar transferência" name="submit"></div>
    </form>
